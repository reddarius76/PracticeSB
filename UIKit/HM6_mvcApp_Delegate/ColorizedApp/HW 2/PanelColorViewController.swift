...
class PanelColorViewController: UIViewController {
    ...
    private func setValue(for sliders: UISlider...) {
        sliders.forEach { slider in
            switch slider.tag {
            case 0:
                redSlider.value = Float(colorView.backgroundColor!.cgColor.components![0])
            case 1:
                greenSlider.value = Float(colorView.backgroundColor!.cgColor.components![1])
            case 2:
                blueSlider.value = Float(colorView.backgroundColor!.cgColor.components![2])
            default: break
            }
        }
    }
