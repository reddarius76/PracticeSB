...
class MainViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        let dataTaskFromFirstPage = NetworkManager.shared.fetchCharacter(url: urlAPI.urlCharacter.rawValue, page: currentPage, dataTasks: dataTasks) { [unowned self] infoCharacter in
    ...
    private func prefetchCharactersFromNextPages() {
        ...
        let dataTaskFromPage = NetworkManager.shared.fetchCharacter(url: urlAPI.urlCharacter.rawValue, page: currentPage, dataTasks: dataTasks) { [unowned self] infoCharacter in
    ...
    private func prefetchForSearchCharactersFromNextPages(searchText: String) {
        ...
        let dataTaskFromPage = NetworkManager.shared.fetchCharacter(url: urlAPI.urlCharacter.rawValue, page: currentPageSearch, name: searchText, dataTasks: dataTasksSearch) { [unowned self] infoCharacter in
...
extension MainViewController: UISearchResultsUpdating {
    ...
    private func filterCharacterForSearchText(_ searchText: String) {
        ...
        let dataTaskFromFirstPageSearch = NetworkManager.shared.fetchCharacter(url: urlAPI.urlCharacter.rawValue, page: currentPageSearch, name: searchText, dataTasks: dataTasksSearch) { [unowned self] infoCharacter in
